...
export default function Showcase() {
  const [activeTab, setActiveTab] = useState<
    "overview" | "students" | "schools" | "supporters" | "demo" | "analytics"
  >("overview");
  const [selectedStudent, setSelectedStudent] = useState<Student | null>(null);
  const [isLoading, setIsLoading] = useState(true);
  const [searchTerm, setSearchTerm] = useState("");
  const [filterBy, setFilterBy] = useState<
    "all" | "urgent" | "crypto" | "engineering" | "medicine"
  >("all");
  ...
  const students: Student[] = [
    {
      ...
      raised: 1750,
      story:
        "Brilliant blockchain developer from Lagos, building DeFi solutions for African financial inclusion.",
      flag: "🇳🇬",
      achievements: [
        "Dean's List",
        "Hackathon Winner",
    ...
    },
    {
      ...
      raised: 2400,
      story:
        "Training to become a pediatric surgeon, dedicated to improving child healthcare.",
      flag: "🇪🇬",
    ...
    },
    {
      ...
      raised: 950,
      story:
        "First in her family to attend university, dreams of building sustainable infrastructure.",
      flag: "🇬🇭",
      achievements: [
  ...
  const schools: School[] = [
    {
      ...
      flag: "🇺🇬",
      description:
        "Premier East African university fostering innovation and academic excellence since 1922.",
      ranking: 4,
      established: "1922",
      programs: [
        "Engineering",
    ...
    },
    {
      ...
      flag: "🇳🇬",
      description:
        "Leading Nigerian institution producing world-class graduates in technology and business.",
      ranking: 2,
      established: "1962",
      programs: [
        "Computer Science",
    ...
    },
    {
      ...
      flag: "🇬🇭",
      description:
        "Historic institution driving research and development across West Africa.",
      ranking: 5,
      established: "1948",
      programs: [
        "Engineering",
  ...
  const supporters: Supporter[] = [
    {
      ...
      flag: "🇺🇸",
      motivation:
        "Former Google executive supporting the next generation of African tech innovators.",
    ...
    },
    {
      ...
      flag: "🇬🇧",
      motivation:
        "Investment banker passionate about education equality and sustainable development.",
    ...
    },
    {
      ...
      flag: "🇮🇳",
      motivation:
        "Medical professional supporting future African doctors and healthcare workers.",
  ...
  const filteredStudents = students.filter((student) => {
    ...
    const matchesFilter =
      ...
      (filterBy === "engineering" &&
        student.course.toLowerCase().includes("engineering")) ||
      (filterBy === "medicine" &&
                  ...
                  <div className="flex justify-between">
                    ...
                    <span
                      className={`font-semibold ${
                        selectedStudent.cryptoFriendly
                          ? "text-green-600"
                          : "text-gray-500"
                      }`}
                    >
                ...
                <div className="bg-gray-50 p-6 rounded-xl">
                  <div className="flex justify-between text-lg mb-4">
                    ...
                    <span className="font-bold text-green-600">
                      ${selectedStudent.raised.toLocaleString()}
                    </span>
                  </div>
                  <div className="flex justify-between text-lg mb-4">
                    <span>Goal:</span>
                    <span className="font-bold">
                      ${selectedStudent.tuitionNeeded.toLocaleString()}
                    </span>
                  </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-orange-50 pt-20">
      ...
      <div className="bg-gradient-to-r from-blue-600 via-purple-600 to-orange-600 text-white py-16">
        <div className="max-w-6xl mx-auto px-4 text-center">
          <Link
            href="/"
            className="text-blue-200 hover:text-white mb-4 inline-block transform hover:scale-105 transition-all"
          >
            ← Back to Home
          </Link>
          ...
          <p className="text-xl text-blue-100 max-w-4xl mx-auto leading-relaxed">
            Connecting African students with global supporters through
            innovative crypto payments, inspired by{" "}
            <strong>Bitnob&apos;s cross-border vision</strong> from Nigeria 🇳🇬
            to Uganda 🇺🇬
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8 pt-6 border-t border-white border-opacity-20">
            <div className="text-center">
              <div className="text-2xl font-bold">
                {impactStats.totalStudentsSupported.toLocaleString()}
              </div>
              <div className="text-blue-100 text-sm">Students Supported</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold">
                ${impactStats.totalAmountRaised.toLocaleString()}
              </div>
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
          ...
          <div className="space-y-12">
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600 max-w-4xl mx-auto">
                TuiShare bridges the gap between talented African students and
                global supporters through blockchain technology, creating
                opportunities for educational excellence across the continent.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-12">
              <div className="bg-gradient-to-br from-blue-500 to-purple-600 text-white rounded-2xl p-8 text-center transform hover:scale-105 transition-all">
                ...
                <p className="opacity-90">
                  Bitcoin, Lightning Network, and USDT payments reach students
                  in seconds, not days.
                </p>
              </div>
              <div className="bg-gradient-to-br from-green-500 to-emerald-600 text-white rounded-2xl p-8 text-center transform hover:scale-105 transition-all">
                ...
                <p className="opacity-90">
                  Supporting students across {impactStats.countriesReached}{" "}
                  African countries with verified academic progress.
                </p>
              </div>
              <div className="bg-gradient-to-br from-orange-500 to-red-500 text-white rounded-2xl p-8 text-center transform hover:scale-105 transition-all">
                ...
                <p className="opacity-90">
                  {impactStats.averageGraduationRate}% graduation rate with{" "}
                  {impactStats.totalTransactions.toLocaleString()} successful
                  transactions.
                </p>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-white rounded-2xl shadow-lg p-8">
                ...
                <p className="text-gray-600 mb-6">
                  Join thousands of supporters who are changing lives through
                  education. Start with as little as $50.
                </p>
                <div className="space-y-3">
                  <button
              ...
              <div className="bg-white rounded-2xl shadow-lg p-8">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="font-bold text-orange-600">
                      {impactStats.averageResponseTime}
                    </span>
                  </div>
                </div>
              </div>
          ...
          <div className="space-y-8">
            <div className="text-center">
              <h2 className="text-3xl font-bold text-gray-800 mb-4">
                👩‍🎓 Brilliant African Students
              </h2>
              <p className="text-gray-600 max-w-2xl mx-auto">
                Meet the next generation of African leaders, innovators, and
                changemakers seeking educational support.
              </p>
            </div>
                  ...
                  <div className="mb-4">
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg">
                      ...
                      <div className="flex justify-between text-sm mb-3">
                        <span>Goal:</span>
                        <span className="font-bold">
                          ${student.tuitionNeeded.toLocaleString()}
                        </span>
                      </div>
        ...
        {activeTab === "schools" && (
          <div className="space-y-8">
            <div className="text-center">
              <h2 className="text-3xl font-bold text-gray-800 mb-4">
                🏫 Premier African Universities
              </h2>
              <p className="text-gray-600 max-w-2xl mx-auto">
                Leading institutions across Africa driving educational
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-4">
                      ...
                      <div className="text-center p-3 bg-green-50 rounded-lg">
                        <div className="font-bold text-green-600">
                          ${school.totalFunded.toLocaleString()}
                        </div>
        ...
        {activeTab === "supporters" && (
          <div className="space-y-8">
            <div className="text-center">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto">
                Meet the incredible supporters making African education dreams
                come true through cryptocurrency.
              </p>
            </div>
                ...
                >
                  <div className="flex items-center justify-between mb-4">
                    <div>
                      ...
                      <p className="text-sm text-gray-500">
                        Member since {supporter.joinedDate}
                      </p>
                    </div>
                    <div className="text-center">
                      <div className="text-lg font-bold text-yellow-600">
                        ⭐ {supporter.impactRating}
                      </div>
        ...
        {activeTab === "analytics" && (
          <div className="space-y-8">
            <div className="text-center">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto">
                Real-time metrics showing the transformative power of
                blockchain-enabled education funding.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              ...
              <div className="bg-gradient-to-br from-purple-500 to-purple-600 text-white rounded-2xl p-6 text-center transform hover:scale-105 transition-all">
                <div className="text-3xl mb-2">🎓</div>
                <div className="text-2xl font-bold">
                  {impactStats.averageGraduationRate}%
                </div>
              ...
              <div className="bg-white rounded-2xl shadow-lg p-6">
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="font-bold text-green-600">
                      {impactStats.totalTransactions.toLocaleString()}
                    </span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-gray-600">Active Schools:</span>
                    <span className="font-bold text-blue-600">
                      {impactStats.activeSchools}
                    </span>
                  </div>
                  <div className="flex justify-between items-center">
        ...
        {activeTab === "demo" && (
          <div className="space-y-8">
            <div className="text-center">
              <h2 className="text-3xl font-bold text-gray-800 mb-4">
                ₿ Live Crypto Payment Demo
              </h2>
              <p className="text-gray-600 max-w-2xl mx-auto">
                Experience our seamless cryptocurrency payment system. Try it
                with demo funds!
              </p>
            </div>
